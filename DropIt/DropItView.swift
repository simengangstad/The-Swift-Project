...
class DropItView: NamedBezierPathsView, UIDynamicAnimatorDelegate {
    ...
    private struct PathNames {
        static let MiddleBarrier = "Middle Barier"
    ...
    func grabDrop(recognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            if let dropToAttachedTo = lastDrop, dropToAttachedTo.superview != nil {
                attachment = UIAttachmentBehavior(item: dropToAttachedTo, attachedToAnchor: gesturePoint)
            }
            lastDrop = nil
        case .changed:
